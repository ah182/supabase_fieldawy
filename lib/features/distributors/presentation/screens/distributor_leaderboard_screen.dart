...
class _DistributorLeaderboardScreenState
      ...
      if (query.isEmpty) {
        ...
        _filteredDistributors = _distributors
            .where((d) =>
                ...
                (d.companyName?.toLowerCase().contains(query.toLowerCase()) ??
                    false))
            .toList();
      }
    });
      ...
      if (mounted) {
        setState(() {
          ...
          _filteredDistributors =
              List.from(_distributors); // Initialize filtered list
          _isLoading = false;
        });
                  ...
                  : _filteredDistributors.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return _buildDistributorListItem(
                                context, distributor, rank, isAr);
                          },
                        ),
        ),
      ),
  ...
  Widget _buildDistributorListItem(
      BuildContext context, DistributorModel distributor, int rank, bool isAr) {
    final theme = Theme.of(context);
        ...
        boxShadow: [
          BoxShadow(
            color: (borderColor ?? Colors.black)
                .withOpacity(borderColor != null ? 0.1 : 0.02),
            blurRadius: 8,
                ...
                if (rank <= 3)
                  Positioned(
                    ...
                    child: CachedNetworkImage(
                      imageUrl:
                          'https://icons.iconarchive.com/icons/fa-team/fontawesome/128/FontAwesome-Crown-icon.png',
                      width: 14,
                      height: 14,
                      color: borderColor,
              ...
              children: [
                if (distributor.role != null) ...[
                  Container(
                    ...
                    child: Text(
                      distributor.role == 'company'
                          ? (isAr ? 'شركة' : 'Company')
                          : (isAr ? 'موزع' : 'Distributor'),
                      style: TextStyle(
                        fontSize: 10,
