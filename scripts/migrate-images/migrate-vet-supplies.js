 ...
 * Target: vet_supplies table (image_url field)
 * Bucket: ocr
 * Folder: supplies
 */
...
/**
 * Migrate a single supply image
 */
async function migrateSupply(record) {
    const { id, image_url, name } = record;

    console.log(`\n🩺 Processing Supply: ${name || id}`);
    console.log(`   ID: ${id}`);
...
async function migrate() {
    console.log('═══════════════════════════════════════════════════════════');
    console.log('🚀 Starting Migration: Vet Supplies Images → Supabase Storage');
    console.log('═══════════════════════════════════════════════════════════');
    ...
    console.log('📊 Fetching supplies from vet_supplies...');
    ...
    console.log(`🩺 Found ${stats.total} supplies with images\n`);

    for (const record of records) {
        await migrateSupply(record);
    ...
    console.log('═══════════════════════════════════════════════════════════');
    console.log(`   Total supplies:    ${stats.total}`);
